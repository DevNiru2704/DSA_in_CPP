...
## Phase 2 Outcome Check (Non-Negotiable)

You are done with Phase 2 only when:

- Segmentation faults feel explainable
- You can predict memory layout on paper
- You stop guessing and start reasoning
- You can say "this is undefined behavior" and justify it